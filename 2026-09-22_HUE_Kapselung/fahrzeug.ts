...
export class Fahrzeug {
  ...
  constructor(
    ...
    // GELÖST: kmStand darf nicht negativ sein — Fail-Fast im Konstruktor.
    if (kmStand < 0) {
  ...
  // GELÖST: getter für kmStand und geschwindigkeit (lesen ja, schreiben nie).
  get kmStand(): number {
  ...
  // GELÖST: wirft, wenn v < 0 oder v > maxGeschwindigkeit.
  ...
  // GELÖST: erhöht kmStand um geschwindigkeit * stunden.
